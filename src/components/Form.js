...
const Form = ({ enrolledStudents, setEnrolledStudents }) => {
  ...
  const submitFormHandler = (event) => {
    ...
    // console.log(arr[3])
    let image;
    if (arr[3].type.startsWith("image/jpeg") || arr[3].type.startsWith("image/png") || arr[3].type.startsWith("image/jpg") || arr[3].type.startsWith("image/webp")) {
      ...
      alert("Image formats supported: .png, .jpeg, .jpg, .webp")
    }
  }
